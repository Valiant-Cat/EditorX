...
Developed by: XiaMao Tools""")
    ...
    put(I18nKeys.Toolbar.TOGGLE_AGENT_PANEL, "Toggle Agent Panel")
    ...
    put(I18nKeys.ToolbarMessage.EXTRACTING_AAR, "Extracting AAR...")
    put(I18nKeys.ToolbarMessage.DECOMPILING_AAR, "Decompiling AAR...")
    put(I18nKeys.ToolbarMessage.PACKING_AAR, "Packing AAR...")
    put(I18nKeys.ToolbarMessage.PACK_AAR_FAILED, "AAR pack failed: %s")
    put(I18nKeys.ToolbarMessage.REBUILDING_AAR_CLASSES, "Rebuilding classes.jar from smali...")
    put(I18nKeys.ToolbarMessage.REBUILD_AAR_CLASSES_FAILED, "Rebuild classes.jar failed: %s")
    put(I18nKeys.ToolbarMessage.EXTRACTING_XAPK, "Extracting XAPK...")
    put(I18nKeys.ToolbarMessage.DECOMPILING_XAPK, "Decompiling XAPK...")
    put(I18nKeys.ToolbarMessage.PACKING_XAPK, "Packing XAPK...")
    put(I18nKeys.ToolbarMessage.PACK_XAPK_FAILED, "XAPK pack failed: %s")
    put(I18nKeys.ToolbarMessage.EXTRACTING_AAB, "Extracting AAB...")
    put(I18nKeys.ToolbarMessage.DECOMPILING_AAB, "Decompiling AAB...")
    put(I18nKeys.ToolbarMessage.PACKING_AAB, "Packing AAB...")
    put(I18nKeys.ToolbarMessage.PACK_AAB_FAILED, "AAB pack failed: %s")
    put(I18nKeys.ToolbarMessage.REBUILDING_AAB_DEX, "Rebuilding dex from smali...")
    put(I18nKeys.ToolbarMessage.REBUILD_AAB_DEX_FAILED, "Rebuild dex failed: %s")
    put(I18nKeys.ToolbarMessage.SMALI_NOT_FOUND, "smali tool not found")
    ...
    put(I18nKeys.Dialog.OPEN_AAR_FILE, "Open AAR File")
    put(I18nKeys.Dialog.DETECTED_AAR, "AAR file detected. Convert to project (extract)?")
    put(I18nKeys.Dialog.AAR_DIR_EXISTS, "AAR output directory \"%s\" already exists.\n\nChoose an action:")
    put(I18nKeys.Dialog.AAR_DIR_EXISTS_TITLE, "Directory Exists")
    put(I18nKeys.Dialog.OPEN_EXISTING_PROJECT, "Open existing project")
    put(I18nKeys.Dialog.REEXTRACT, "Extract again")
    put(I18nKeys.Dialog.AAR_EXTRACT_FAILED, "AAR extract failed: %s")
    put(I18nKeys.Dialog.OPEN_XAPK_FILE, "Open XAPK File")
    put(I18nKeys.Dialog.DETECTED_XAPK, "XAPK file detected. Convert to project (extract & decompile)?")
    put(I18nKeys.Dialog.XAPK_DIR_EXISTS, "XAPK output directory \"%s\" already exists.\n\nChoose an action:")
    put(I18nKeys.Dialog.XAPK_DIR_EXISTS_TITLE, "Directory Exists")
    put(I18nKeys.Dialog.XAPK_EXTRACT_FAILED, "XAPK extract failed: %s")
    put(I18nKeys.Dialog.OPEN_AAB_FILE, "Open AAB File")
    put(I18nKeys.Dialog.DETECTED_AAB, "AAB file detected. Convert to project (extract)?")
    put(I18nKeys.Dialog.AAB_DIR_EXISTS, "AAB output directory \"%s\" already exists.\n\nChoose an action:")
    put(I18nKeys.Dialog.AAB_DIR_EXISTS_TITLE, "Directory Exists")
    put(I18nKeys.Dialog.AAB_EXTRACT_FAILED, "AAB extract failed: %s")
