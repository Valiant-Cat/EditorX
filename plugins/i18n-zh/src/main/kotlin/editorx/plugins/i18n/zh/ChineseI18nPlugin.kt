...
开发：XiaMao Tools""")
    ...
    put(I18nKeys.ToolbarMessage.EXTRACTING_AAR, "正在解压 AAR...")
    put(I18nKeys.ToolbarMessage.DECOMPILING_AAR, "正在反编译 AAR...")
    put(I18nKeys.ToolbarMessage.PACKING_AAR, "正在打包 AAR...")
    put(I18nKeys.ToolbarMessage.PACK_AAR_FAILED, "AAR 打包失败: %s")
    put(I18nKeys.ToolbarMessage.REBUILDING_AAR_CLASSES, "正在根据 smali 重建 classes.jar...")
    put(I18nKeys.ToolbarMessage.REBUILD_AAR_CLASSES_FAILED, "重建 classes.jar 失败: %s")
    put(I18nKeys.ToolbarMessage.EXTRACTING_XAPK, "正在解压 XAPK...")
    put(I18nKeys.ToolbarMessage.DECOMPILING_XAPK, "正在反编译 XAPK...")
    put(I18nKeys.ToolbarMessage.PACKING_XAPK, "正在打包 XAPK...")
    put(I18nKeys.ToolbarMessage.PACK_XAPK_FAILED, "XAPK 打包失败: %s")
    put(I18nKeys.ToolbarMessage.EXTRACTING_AAB, "正在解压 AAB...")
    put(I18nKeys.ToolbarMessage.DECOMPILING_AAB, "正在反编译 AAB...")
    put(I18nKeys.ToolbarMessage.PACKING_AAB, "正在打包 AAB...")
    put(I18nKeys.ToolbarMessage.PACK_AAB_FAILED, "AAB 打包失败: %s")
    put(I18nKeys.ToolbarMessage.REBUILDING_AAB_DEX, "正在根据 smali 重建 dex...")
    put(I18nKeys.ToolbarMessage.REBUILD_AAB_DEX_FAILED, "重建 dex 失败: %s")
    put(I18nKeys.ToolbarMessage.SMALI_NOT_FOUND, "未找到 smali 工具")
    ...
    put(I18nKeys.Dialog.OPEN_AAR_FILE, "打开 AAR 文件")
    put(I18nKeys.Dialog.DETECTED_AAR, "检测到 AAR 文件。是否要将其转换为项目（解压）？")
    put(I18nKeys.Dialog.AAR_DIR_EXISTS, "此 AAR 对应的目录 \"%s\" 已存在。\n\n请选择操作：")
    put(I18nKeys.Dialog.AAR_DIR_EXISTS_TITLE, "目录已存在")
    put(I18nKeys.Dialog.OPEN_EXISTING_PROJECT, "打开已存在的项目")
    put(I18nKeys.Dialog.REEXTRACT, "重新解压")
    put(I18nKeys.Dialog.AAR_EXTRACT_FAILED, "解压 AAR 失败：%s")
    put(I18nKeys.Dialog.OPEN_XAPK_FILE, "打开 XAPK 文件")
    put(I18nKeys.Dialog.DETECTED_XAPK, "检测到 XAPK 文件。是否要将其转换为项目（解压并反编译）？")
    put(I18nKeys.Dialog.XAPK_DIR_EXISTS, "此 XAPK 对应的目录 \"%s\" 已存在。\n\n请选择操作：")
    put(I18nKeys.Dialog.XAPK_DIR_EXISTS_TITLE, "目录已存在")
    put(I18nKeys.Dialog.XAPK_EXTRACT_FAILED, "解压 XAPK 失败：%s")
    put(I18nKeys.Dialog.OPEN_AAB_FILE, "打开 AAB 文件")
    put(I18nKeys.Dialog.DETECTED_AAB, "检测到 AAB 文件。是否要将其转换为项目（解压）？")
    put(I18nKeys.Dialog.AAB_DIR_EXISTS, "此 AAB 对应的目录 \"%s\" 已存在。\n\n请选择操作：")
    put(I18nKeys.Dialog.AAB_DIR_EXISTS_TITLE, "目录已存在")
    put(I18nKeys.Dialog.AAB_EXTRACT_FAILED, "解压 AAB 失败：%s")
