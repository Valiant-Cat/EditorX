...
object I18nKeys {
    ...
    object Dialog {
        ...
        const val OPEN_XAPK_FILE = "dialog.openXapkFile"
        const val DETECTED_XAPK = "dialog.detectedXapk"
        const val XAPK_DIR_EXISTS = "dialog.xapkDirExists"
        const val XAPK_DIR_EXISTS_TITLE = "dialog.xapkDirExistsTitle"
        const val XAPK_EXTRACT_FAILED = "dialog.xapkExtractFailed"
        const val OPEN_AAB_FILE = "dialog.openAabFile"
        const val DETECTED_AAB = "dialog.detectedAab"
        const val AAB_DIR_EXISTS = "dialog.aabDirExists"
        const val AAB_DIR_EXISTS_TITLE = "dialog.aabDirExistsTitle"
        const val AAB_EXTRACT_FAILED = "dialog.aabExtractFailed"
    }
    ...
    object ToolbarMessage {
        ...
        const val EXTRACTING_XAPK = "toolbarMessage.extractingXapk"
        const val DECOMPILING_XAPK = "toolbarMessage.decompilingXapk"
        const val PACKING_XAPK = "toolbarMessage.packingXapk"
        const val PACK_XAPK_FAILED = "toolbarMessage.packXapkFailed"
        const val EXTRACTING_AAB = "toolbarMessage.extractingAab"
        const val DECOMPILING_AAB = "toolbarMessage.decompilingAab"
        const val PACKING_AAB = "toolbarMessage.packingAab"
        const val PACK_AAB_FAILED = "toolbarMessage.packAabFailed"
        const val REBUILDING_AAB_DEX = "toolbarMessage.rebuildingAabDex"
        const val REBUILD_AAB_DEX_FAILED = "toolbarMessage.rebuildAabDexFailed"
        const val SMALI_NOT_FOUND = "toolbarMessage.smaliNotFound"
